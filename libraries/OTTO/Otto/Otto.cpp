...
//---------------------------------------------------------
//-- Otto movement: userservo
//--  Parameters:
//--    s10~s13: servo degree (default degree 90)
//--    T: Period
//---------------------------------------------------------
void Otto::userServo(int s10, int s11, int s12, int s13, int T){

  int _move[]={s10,s11,s12,s13};
  _moveServos(T,_move);
}
...
*/
  //Parameters of all the movements. Default: Left bend
  int bend1[4]={90, 90, 60, 45}; 
  int bend2[4]={90, 90, 55, 20};
  int bend3[4]={90, 90, 60, 100};
  int homes[4]={90, 90, 90, 90};
...
*/
  ...
  for (int i=0;i<steps;i++)
  {
    ...
    _moveServos(T2/2,bend3);
    delay(T*0.8);
    _moveServos(800,homes);
  }
}
...
void Otto::shakeLeg (int steps,int T,int dir){
  ...
  int shake_leg1[4]={90, 90, 60, 20}; 
  int shake_leg2[4]={90, 90, 55, 20}; 
  int shake_leg3[4]={90, 90, 60, 105};
  int shake_leg4[4]={90, 90, 60, 50};
  int homes[4]={90, 90, 90, 90};
  ...
  */ 
  ...
  _moveServos(T2/2,shake_leg1);
  _moveServos(T2/2,shake_leg2);
  _moveServos(T2/2,shake_leg3);
  
    //Shake movement
    for (int i=0;i<numberLegMoves;i++)
    {
    _moveServos(T/(2*numberLegMoves),shake_leg4);
    _moveServos(T/(2*numberLegMoves),shake_leg3);
    }
    _moveServos(800,homes); //Return to home position
  }
...
//-- OTTO Melody ------------------------------------------------//
///////////////////////////////////////////////////////////////////
void Otto::melody(int mld, int meter){
	int noteDuration = 1000 / meter;
	tone(4, mld, noteDuration);
	int pauseBetweenNotes = noteDuration * 1.30;
	delay(pauseBetweenNotes);
	noTone(4);
}
